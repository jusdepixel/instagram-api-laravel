...
Route:: middleware([
    ...
    //
    //    Route::get('/user',
    // \Jusdepixel\InstagramApiLaravel\Http\Controllers\Api\Refresh\UserController::class)
    //        ->name('refresh@user');
    //
    //    Route::get('/post',
    // \Jusdepixel\InstagramApiLaravel\Http\Controllers\Api\Refresh\PostController::class)
    //        ->name('refresh@post');
    //});
});
